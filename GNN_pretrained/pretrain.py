...
from PubChemProcess import ChemBI_HMDB_Datasets_Graph
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="ChemBI_HMDB")
    parser.add_argument("--text_type", type=str, default="SciBERT")
    parser.add_argument("--molecule_type", type=str, default="Graph")
    ...
    # for contrastive SSL #
    parser.add_argument("--SSL_loss", type=str, default="InfoNCE")
    parser.add_argument("--SSL_emb_dim", type=int, default=512)
    ...
    if "ChemBI_HMDB" in args.dataset:
        dataset_root = os.path.join(args.dataspace_path, "ChemBI_HMDB_data")
    else:
        raise Exception
    ...
    if args.text_type == "SciBERT":
        ...
        bert_name = 'data/pretrained_SciBERT/allenai/scibert_scivocab_uncased'
        ...
        # text_tokenizer = AutoTokenizer.from_pretrained('data/pretrained_SciBERT/allenai/scibert_scivocab_uncased')
        # text_model = AutoModel.from_pretrained('data/pretrained_SciBERT/allenai/scibert_scivocab_uncased').to(device)
