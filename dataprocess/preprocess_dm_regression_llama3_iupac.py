...
class CheBIDataset(Dataset):
    def __init__(self, path, text_max_len):
        ...
        #                 self.reg_g + '.'
        self.prompt_3 = '\n Please generate the predictions ' + \
                        self.reg_g + '.'
        ...
        for line in lines:
            ...
            # smiles, instruction, text, _, _, _, _ = line.split('\t')
            instruction, smiles, text, iupac, _ = line.split('\t')  # construct_syn_qm9
            # instruction, smiles, text, iupac = line.split('\t')  # single_task_qm9
...
class ProcessDatasets(LightningDataModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--root', type=str, default='data/finetune/pubchemqc/gap')
