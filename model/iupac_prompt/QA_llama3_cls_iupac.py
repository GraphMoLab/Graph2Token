...
def init_graph_encoder(gin_num_layers, gin_hidden_dim, gin_drop_ratio):
    ...
    input_model_path = '/home/wrz/MoleculeSTM/output_model/molecule_model_final.pth'
...
def init_mol2latent(gin_hidden_dim):
    ...
    input_model_path = '/home/wrz/MoleculeSTM/output_model/mol2latent_model_final.pth'
